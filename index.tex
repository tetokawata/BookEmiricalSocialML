...
\title{Rによる比較・因果推論・予測研究}
\author{川田恵介}
\date{8/15/2022}

\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, enhanced, breakable, sharp corners, interior hidden, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
\item
  Example dataとしては、AERパッケージに含まれるNMES1988(the US National
  Medical Expenditure Survey)を利用
\end{itemize}
